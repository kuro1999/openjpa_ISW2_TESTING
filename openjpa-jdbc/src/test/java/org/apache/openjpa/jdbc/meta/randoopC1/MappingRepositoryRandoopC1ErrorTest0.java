...
public class MappingRepositoryRandoopC1ErrorTest0 {
    ...
    public void test1() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "MappingRepositoryRandoopC1ErrorTest0.test1");
    ...
    public void test2() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "MappingRepositoryRandoopC1ErrorTest0.test2");
        org.apache.openjpa.jdbc.meta.MappingRepository mappingRepository0 = new org.apache.openjpa.jdbc.meta.MappingRepository();
        mappingRepository0.startConfiguration();
        org.apache.openjpa.jdbc.meta.QueryResultMapping[] queryResultMappingArray2 = mappingRepository0.getQueryResultMappings();
        mappingRepository0.setValidate(0);
    ...
    public void test3() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "MappingRepositoryRandoopC1ErrorTest0.test3");
        org.apache.openjpa.jdbc.meta.MappingRepository mappingRepository0 = new org.apache.openjpa.jdbc.meta.MappingRepository();
        mappingRepository0.startConfiguration();
    ...
    public void test4() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "MappingRepositoryRandoopC1ErrorTest0.test4");
        org.apache.openjpa.jdbc.meta.MappingRepository mappingRepository0 = new org.apache.openjpa.jdbc.meta.MappingRepository();
        mappingRepository0.startConfiguration();
