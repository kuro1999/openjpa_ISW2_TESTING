...
public class DBIdentifierUtilImplRandoopC1ErrorTest0 {
    ...
    public void test1() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "DBIdentifierUtilImplRandoopC1ErrorTest0.test1");
    ...
    public void test2() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "DBIdentifierUtilImplRandoopC1ErrorTest0.test2");
        org.apache.openjpa.jdbc.identifier.DBIdentifierUtilImpl dBIdentifierUtilImpl0 = new org.apache.openjpa.jdbc.identifier.DBIdentifierUtilImpl();
        // during test generation this statement threw an exception of type java.lang.NullPointerException in error
    ...
    public void test3() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "DBIdentifierUtilImplRandoopC1ErrorTest0.test3");
        org.apache.openjpa.jdbc.identifier.DBIdentifierUtilImpl dBIdentifierUtilImpl0 = new org.apache.openjpa.jdbc.identifier.DBIdentifierUtilImpl();
        // during test generation this statement threw an exception of type java.lang.NullPointerException in error
